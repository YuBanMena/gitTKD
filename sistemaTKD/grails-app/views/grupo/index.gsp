...
<content tag="header">
    <ol class="breadcrumb">
        ...
        <li><a href="${createLink(uri: '/grupo/index')}"><i class="fa fa-building"></i>Grupo</a></li>
    </ol>
</content>
<br>
...
<div class="box box-danger">
    <div class="box-header with-border">
        <h3 class="box-title">
            Lista de Grupos de la Sucursal
        </h3>

          <div class="pull-right">
            <a class="btn btn-success" href="${createLink(uri: "/grupo/create")}">Registrar Grupo</a>
        </div>
    </div>
    <div class="box-body">
                ...
                <tbody>
                    <g:each in="${grupos}">
                        <tr>
                            ...
                            <td>${it.modalidad}</td>
                            <td>${it.programa}</td>
                            <td><button class="btn btn-primary">Ver Alumnos</button></td>
                            <td>

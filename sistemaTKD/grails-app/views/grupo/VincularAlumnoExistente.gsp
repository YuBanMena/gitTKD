...
<div class="box box-danger">
    <div class="box-header with-border">
        <h3 class="box-title">
            Lista de Alumnos del grupo : (${grupo.id}) a cargo de
             <strong> ${grupo.profesorDelGrupo.nombre}  ${grupo.profesorDelGrupo.apellidos} </strong>
        </h3>
    </div>
    <div class="box-body">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center bg-danger text-white">
                            ¿Está seguro que desea vincular
                            "${alumno.nombre}"?
                            <br />
                            <br />
                        ...
                        <div class="modal-footer">
                            ...
                            <g:link action="vincular" controller="grupo"
                                params="['alumno': alumno.id,'grupo':grupo.id]"

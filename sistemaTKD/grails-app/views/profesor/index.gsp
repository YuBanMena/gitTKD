...
<g:each in="${profesores}" var="profesor">
            <div class="modal fade" id="modal${profesor.id}" tabindex="-1"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center bg-danger text-white">
                            ...
                            " <strong>${profesor.nombre} ${profesor.apellidos}</strong>" ?
                            <br />
                            <br />
                        ...
                        <div class="modal-footer">
                            ...
                            <g:link action="eliminar" id="${profesor.id}" controller="profesor"
                                params="['profesor': profesor.id]"

...
<html>
    ...
    <body>
        ...
        <div id="show-grado" class="content scaffold-show" role="main">
            ...
            <f:display bean="grado" />
            <g:form resource="${this.grado}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.grado}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
